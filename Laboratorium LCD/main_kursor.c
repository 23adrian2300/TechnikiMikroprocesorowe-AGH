...
//  BSP_LCD_DrawRect(50,50,100,80);
  BSP_LCD_FillRect(50,50,100,80);

  Point points[] = {{250,50},{250,100},{300,200},{300,60}};
  BSP_LCD_SetTextColor(LCD_COLOR_GREEN);
//  BSP_LCD_DrawPolygon(points,4);
  BSP_LCD_FillPolygon(points,4);
  BSP_LCD_SetTextColor(LCD_COLOR_RED);
  BSP_LCD_FillCircle(160,150,10);

  BSP_LCD_SetTextColor(LCD_COLOR_BROWN);
  BSP_LCD_DisplayStringAt(0, 0, "Semafor Kolejowy", RIGHT_MODE);
}
...
void putcursor(void)
{
  if( cursorUpd )
  {
    ...
    BSP_LCD_SelectLayer(LCD_LAYER_FG);
    BSP_LCD_SetTextColor(0x5FFF0020);
    BSP_LCD_FillCircle( cursorX, cursorY , SIZE/2 );
